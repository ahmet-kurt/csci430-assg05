...
1. Create your own private copy of the assignment repository from
   ...
   repository for 'Assignment 05: Process Scheduler Simulation' at

   https://github.com/ahmet-kurt/csci430-assg05

   and select "Use this template" -> "Create a new repository".  Make
   sure the owner is your own GitHub account, name your repository
   `assg05-lastname` (using your own last name), and set the
...
create and push your commit to your GitHub repository.
...
2. A zip archive of your final repository contents.  You can create
   ...
   `git archive --format=zip --output=assg05-submission.zip main`
